...
public class RecyclerListViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_recyclerview, container, false); //The view here implements the viewStyle @style/myRecyclerViewStyle hence the padding on the final view
    }
...
/*    private boolean supportsViewElevation() {
    ...
    public AbstractExpandableDataProvider getDataProvider() {
        return ((SubjectListActivity) getActivity()).getDataProvider();
    }
}
